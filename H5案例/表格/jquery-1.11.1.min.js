...
jQuery.extend(
{
    ...
    ImplantStyle: function (Module, Skin)
    {
        ...
        if (!Config)
        {
            ...
            var Path = Script.attr("src").replace(Module + ".js", "");
            if (!Skin)
            {
                Skin = Script.attr("skin") || "Default";
            }
            Script.after("<link href=\"" + Path + "Skins/" + Skin + "/skin.css\" rel=\"stylesheet\" type=\"text/css\" />");
